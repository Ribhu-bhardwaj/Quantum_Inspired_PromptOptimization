...
> **⚠️ Important:** This is a **base implementation with very small data splits** (10/10/20). The original GAAPO paper uses 50/50/200 splits. Dataset sizes can be easily scaled up — see [Configuration](#%EF%B8%8F-configuration--customization).
